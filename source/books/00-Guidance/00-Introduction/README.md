...
## ICH 内容范围与应用简介
### 简介
国际人用药品注册技术协调会（ICH）是一个国际性非盈利组织，该组织依照瑞士法律成立于2015年10月。ICH 的宗旨是通过对技术要求的国际协调来提高公众健康。这些技术标准有利于确保患者持续获得已批准药品，避免不必要的人体临床试验重复，并以高效、经济的方式进行研究、注册与生产安全、有效且高质量的药品；同时在不影响安全性和有效性的前提下最大限度减少动物试验。

### 目的 
- 通过对相关技术要求进行国际协调，加快创新药物的引入，确保患者能够持续获得已批准药物，从而促进公众健康。
- 避免在人体上重复开展临床试验，以经济有效的方式保存与传递证据。
- 保障药品在注册与生产环节中的安全性、有效性与高质量。
- 在不影响安全性和有效性的前提下，尽可能减少动物试验。

### 任务及目标
- 就药品注册与维护中的技术指导原则和技术要求的解释与应用提出建议，以实现更高程度的国际协调。
- 维护交流与对话平台，围绕药品技术要求的协调，在监管机构与医药行业之间开展理性、科学的沟通。
- 从国际视角出发，为保护公众健康作出贡献。
- 监测并更新前沿技术要求，促进不同来源的研发数据更大范围的相互接受。
- 针对因治疗进展与经验积累而变化的技术要求开展协调，避免未来出现要求不一致的情况。
- 促进更高效的技术研究与开发方法的应用，更新或优化现有实践。
- 促进协调的医学词库及其用于通信的技术标准的整合、交流与应用，鼓励新标准的实施与持续推进。
- 监督医学词库（如 MedDRA）的管理与术语适配，规范术语变更；同时确保 MedDRA 用于人用药品国际监管机构之间的标准化沟通，并实现共享、维护、开发与传播。
